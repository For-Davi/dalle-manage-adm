...
namespace App\Models\DallePayments;

use App\Models\DalleManage\UsersDM;
use Illuminate\Database\Eloquent\Model;

class PaymentsDM extends Model
{
    protected $connection = 'dalle_payments';

    protected $table = 'payments_dalle_manage';
    ...
    {
        return $this->belongsTo(UsersDM::class, 'user_id', 'id');
    }
}
